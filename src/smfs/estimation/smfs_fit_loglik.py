...
def compute(data_df, sites_df, ac_limit):
    ...
    def estimate_non_singleton(z, i_count:list, noni_count:list, prob_one_unq:list, p_recurrent:list,prob_i_or_more:list):
        # print(prob_i_or_more)
        # print((log_it_bounded(z, prob_ac_one_unq_mut)*prob_one_unq + p_recurrent))
...
if __name__ == "__main__":
    ...
    prob_ac_one_unq_mut = compute(data_df, sites_df, ac_limit)
